...
function loadModel($modelName) {
    require_once(MODEL_PATCH . "/{$modelName}.php");
}
...
function loadView($viewName, $params = array()) {
    ...
    require_once(VIEW_PATCH . "/{$viewName}.php");
}
...
function loadTemplateView($viewName, $params = array()) {
    ...
    require_once(TEMPLATE_PATCH . "/header.php");
    require_once(TEMPLATE_PATCH . "/left.php");
    require_once(VIEW_PATCH . "/{$viewName}.php");
    require_once(TEMPLATE_PATCH . "/footer.php");
}

function renderTitle($title, $subtitle, $icon = null) {
    require_once(TEMPLATE_PATCH . "/title.php");
}